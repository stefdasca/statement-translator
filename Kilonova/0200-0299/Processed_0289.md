...
To gain Sabin's favor, you need to answer `Q` queries of the form: â€œGiven `K` books from the second shelf, find all compartments in **the first shelf** that have a degree of similarity with the given compartment **exactly X** and print their count.â€
