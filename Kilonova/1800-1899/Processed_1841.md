...
The BR-PERM inhabitants ask Roxana to help them with this problem (it seems that witches always help people solve their problems). They show her a sequence of $n$ dancers and ask her to answer multiple questions: â€œIs the subarray of length $2^k$ that starts at dancer $i$ _cute_?â€
