...
This year, the event â€œHour of Codeâ€ recorded a record number of participants from our country. In this event, one of the most accessed applications was **Lightbot**, which allowed students to test their programming skills.
