...
Write a program to restore the assignment to the form required by the teacher. Each exercise will be written on a separate line, without any spaces. Each line will end with a â€œ;â€ (semicolon). Additionally, you will have to find the missing numbers!
